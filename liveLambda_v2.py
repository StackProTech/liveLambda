...
class LiveLambdaV2:
    ...
    def register_route(self, route, methods, handler):
        ...
        # Instead use @app.route() decorator to register handler functions.
    ...
    def run(self, event, context):
        ...
        self.request.mics = {"version": event["version"], "routeKey": event["routeKey"], "rawPath": event["rawPath"],
                             "rawQueryString": event["rawQueryString"], "isBase64Encoded": event["isBase64Encoded"]}
